function err_percentage = k_fold_cross_validaion_arc(X, y, k, arcs)
...
%     size_xtrain = size(xtrain)
    ...
    [err(i5), err2(i5)] = fun_mlp_classifier_fitnet_arc(xtrain, ytrain, xtest, ytest, arcs);
end

err_percentage = sum(err2)/num_samples
err_percentage1 = sum(err)/num_samples
